...
namespace Slamby.TAU
{
    public class SlambySettingsProvider : SettingsProvider
    {
        ...
        {
            Directory.CreateDirectory(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "Slamby"));
        ...
        {
            get { return "SlambySettingsProvider"; }
        }
        public virtual string GetAppSettingsPath()
        {
            //Used to determine where to store the settings
            return Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "Slamby");
        }
